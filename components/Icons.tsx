...
export const LogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="m14.6 13.5 1 1"></path>
        <path d="M12 18v1"></path>
        <path d="m9.4 16.5-1-1"></path>
        <path d="m14.6 16.5-1-1"></path>
        <path d="M15 15h1"></path>
        <path d="m9.4 13.5 1 1"></path>
        <path d="M9 15H8"></path>
    </svg>
);
...
export const AnalyzeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 20h.01"/><path d="M12 6h.01"/><path d="M12 12h.01"/><path d="M12 16h.01"/><path d="M12 8h.01"/><path d="M4.5 12H2"/><path d="M7.5 12H6"/><path d="M12 4.5V2"/><path d="M12 7.5V6"/><path d="M18 12h-1.5"/><path d="M22 12h-2.5"/><path d="M6 12h.01"/><path d="M16 12h.01"/><path d="M12 18v-1.5"/><path d="M12 22v-2.5"/></svg>
);
